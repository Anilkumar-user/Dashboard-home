...
const countryData = [
  {
    ...
    value: '$230,900',
    bounce: '29.9%',
    icon: 'https://flagcdn.com/us.svg', // Add a URL for the country's flag or icon
  },
  {
    country: 'Germany',
    sales: 3900,
        ...
        <Grid item xs={12}>
          <Card sx={{ borderRadius: '8px' }}>
            <CardContent>
              ...
              <Box
                sx={{
                  height: '300px', // Decreased height for the line chart
                  overflow: 'hidden',
                  display: 'flex',
              ...
              >
                <Line
                  ...
                  options={{
                    ...lineChartOptions,
                    maintainAspectRatio: false, // Allow chart to adjust to the container height
                  }}
                />
              </Box>
            </CardContent>
